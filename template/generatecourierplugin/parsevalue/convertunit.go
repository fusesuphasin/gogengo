...
type ConvertUnitTemplate struct{}

func (mt *ConvertUnitTemplate) ConvertUnitTemplate(file *os.File) {

	convertunitTemplate.Execute(file, struct {
	}{})
}

var convertunitTemplate = template.Must(template.New("").Parse(
	`package parsevalue
